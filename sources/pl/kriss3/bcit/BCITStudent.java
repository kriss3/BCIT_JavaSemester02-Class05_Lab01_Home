...
public class BCITStudent extends Student 
{
	...
	{
		return String.format("%s is a %s of %s (Student#: %s) at the %s campus. %s was born in %d.", super.getFullName(), this.getClass().getSimpleName(), super.getMajor(), bcitStudentNumber,
				sCampus, super.getGenderIndicator(), super.getYearOfBirth());
	}
}
